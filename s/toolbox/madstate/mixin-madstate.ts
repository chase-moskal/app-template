...
import {Subscribe} from "xiome/x/toolbox/pubsub.js"
import {Track} from "../madstate/parts/types.js"
import {Constructor, LitBase} from "xiome/x/framework/component/types/component-types.js"

export function mixinMadstateTracking(...tracks: Track[]) {
	return function<C extends Constructor<LitBase & {render(): void}>>(Base: C) {
